...
const NEWSLETTER_IMAGE = "https://wallpapermural.com/cdn/shop/products/Vase_of_Flower_Artwork.jpg?v=1750700675";
      ...
      <div className="rounded-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 bg-muted/40 border border-border">
        ...
        <div className="flex flex-col justify-center p-8 md:p-10">
          ...
          <p className="text-muted-foreground text-sm mb-6 leading-relaxed">
            New posts delivered to your inbox.<br />No spam, ever.
          </p>
          ...
          {status === "duplicate" && (
            <p className="text-xs text-muted-foreground mt-2">Already subscribed with this email.</p>
          )}
          {status === "error" && (
